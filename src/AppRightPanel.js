      ...
      <div className="rightpanel-wrapper">
        <div className="rightpanel-section weather-section">
          ...
          <div className="weather">
            <img src="assets/demo/images/LogoNotary.png" alt="LogoNotary.png" />
        ...
        <div className="rightpanel-section favorites-section">
          ...
          <div className="favorite-items">
            <button className="p-link favorite-item">
              <img
                src="assets/demo/images/rightpanel/github.svg"
                alt="freya-layout"
              />
            </button>
            <button className="p-link favorite-item">
              <img
                src="assets/demo/images/rightpanel/slack.svg"
                alt="freya-layout"
              />
            </button>
            <button className="p-link favorite-item">
              <img
                src="assets/demo/images/rightpanel/aws.svg"
                alt="freya-layout"
              />
            </button>
            <button className="p-link favorite-item">
              <img
                src="assets/demo/images/rightpanel/jenkins.svg"
                alt="freya-layout"
              />
            </button>
            <button className="p-link favorite-item">
              <img
                src="assets/demo/images/rightpanel/jira.svg"
                alt="freya-layout"
              />
            </button>
