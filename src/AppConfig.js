...
const AppConfig = (props) => {
        ...
        {themes.map((theme) => {
          return (
            <div key={theme.name}>
              <button
                type="button"
                className="p-link layout-config-option-color"
  ...
  return (
    <div id="layout-config">
      <Button
        className="p-link layout-config-button"
        icon="pi pi-cog"
      ...
      <div className={configClassName} onClick={props.onConfigClick}>
        ...
        <div className="field-radiobutton">
          <RadioButton
            ...
            onChange={(e) => props.onMenuModeChange(e.value)}
          ></RadioButton>
          ...
          <div>
            ...
            <div className="field-radiobutton">
              <RadioButton
                name="themeScheme"
                value="light"
                inputId="themeScheme1"
                disabled={props.colorScheme === "dark"}
                checked={props.themeScheme === "light"}
                onChange={(e) => props.onThemeSchemeChange(e.value)}
              ></RadioButton>
            ...
            <div className="field-radiobutton">
              <RadioButton
                name="themeScheme"
                value="dark"
                inputId="themeScheme2"
                disabled={props.colorScheme === "dark"}
                checked={props.themeScheme === "dark"}
                onChange={(e) => props.onThemeSchemeChange(e.value)}
              ></RadioButton>
          ...
          <div>
            ...
            <div className="field-radiobutton">
              <RadioButton
                name="topbarScheme"
                value="light"
                inputId="topbarScheme1"
                disabled={props.colorScheme === "dark"}
                checked={props.topbarScheme === "light"}
                onChange={(e) => props.onTopbarSchemeChange(e.value)}
              ></RadioButton>
            ...
            <div className="field-radiobutton">
              <RadioButton
                name="topbarScheme"
                value="dark"
                inputId="topbarScheme2"
                disabled={props.colorScheme === "dark"}
                checked={props.topbarScheme === "dark"}
                onChange={(e) => props.onTopbarSchemeChange(e.value)}
              ></RadioButton>
          ...
          <div>
            ...
            <div className="field-radiobutton">
              <RadioButton
                ...
                inputId="menuScheme1"
                disabled={props.colorScheme === "dark"}
                checked={props.menuScheme === "light"}
                onChange={(e) => props.onMenuSchemeChange(e.value)}
              ></RadioButton>
